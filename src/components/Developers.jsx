...
import AakashImg from "../assets/Akash77.jpg"
import AbhayImg from "/src/assets/abhay.png"
  ...
  return (
    <section className="bg-transparent pt-32">
      <div className="container mx-auto px-20">
        ...
        <h2 className="lg:text-5xl text-4xl md:text-5xl font-semibold text-gray-100 mb-6">Developer & Project</h2>
